...
import org.jbpm.console.ng.ht.client.editors.taskslist.grid.*;
...
@Dependent
@WorkbenchScreen(identifier = "Dash Tasks List")
public class DashTasksListGridPresenter extends AbstractScreenListPresenter<TaskSummary> {
  public static String FILTER_STATUSES_PARAM_NAME = "statuses";
  public static String FILTER_CURRENT_ROLE_PARAM_NAME = "filter";

  public interface DashTaskListView extends ListView<TaskSummary, DashTasksListGridPresenter> {

    }

  @Inject
  private DashTaskListView view;
  ...
  public DashTasksListGridPresenter() {
  ...
  @WorkbenchPartView
  public UberView<DashTasksListGridPresenter> getView() {
    return view;
  }
