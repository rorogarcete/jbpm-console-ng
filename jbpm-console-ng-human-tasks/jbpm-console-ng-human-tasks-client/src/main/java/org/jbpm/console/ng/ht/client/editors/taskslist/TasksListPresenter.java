...
public class TasksListPresenter {
    ...
    public void refresh1DaysActiveTasks(Date fromDate) {
        refreshActiveTasks(fromDate, TaskView.DAY);
    }

    public void refreshWeekActiveTasks(Date fromDate) {
        refreshActiveTasks(fromDate, TaskView.WEEK);
    }

    public void refreshMonthActiveTasks(Date fromDate) {
        refreshActiveTasks(fromDate, TaskView.MONTH);
    }
    ...
    public void refreshActiveTasks(Date date, TaskView taskView) {
        ...
        if(taskView.equals(TaskView.GRID)){
            ...
            }).getTasksAssignedFromDateToDateByDays(identity.getName(), fromDate, daysTotal, "en-UK");
        }
    }
